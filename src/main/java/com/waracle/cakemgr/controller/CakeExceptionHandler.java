...
public class CakeExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({ CakeIdMismatchException.class, ConstraintViolationException.class,
	...
	protected ResponseEntity<Object> handleNotFound(Exception ex, WebRequest request) {
		return handleExceptionInternal(ex, "Cake not found", new HttpHeaders(), HttpStatus.NOT_FOUND, request);
	}
}
